...
body,td,th {
	...
	color:rgb(41, 153, 187);
	font-size: 12px;
}
.style1 {color:rgb(182, 39, 20)}
.style2 {
	color:rgba(17, 69, 180, 0.82);
	font-weight: bold;
}
.style3 {color:rgb(25, 31, 110)}
.style7 {color:rgb(70, 7, 170); font-style: italic; }
body {
	background-color:rgb(14, 190, 190);
}
.style8 {color:0rgb(32, 23, 165)}
  ...
  <tbody><tr>
    <td><h1 align="center">&nbsp;</h1>
      ...
      <table width="82%" border="0" align="center" cellpadding="5" cellspacing="0">
        ...
        <tr>
          <td colspan="5" align="right"><h4>Created by: &lt;<em>Jay F. Rodinas</em>&gt;</h4></td>
        </tr>
      </tbody>
    </table>      
